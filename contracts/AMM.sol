...
contract AMM {
    ...
    // Determine how many token2 tokens need to be deposited when depositing liquidity for token1
    ...
    // Determine how many token1 tokens need to be deposited when depositing liquidity for token2
    ...
    function swapToken1(
        uint256 _token1Amount
    ) public returns (uint256 token2Amount) {
    ...
    function swapToken2(
        uint256 _token2Amount
    ) public returns (uint256 token1Amount) {
        // Calculate token 2 amount
